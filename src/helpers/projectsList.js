...
const projects = [
  {
    title: 'Dior',
    skills: 'Html, CSS, JS, Swiperjs, адаптація сайту під мобільні пристрої',
    img: project01,
    imgBig: project01Big,
    gitHubLink: 'https://github.com/githabb/DiorWeb.git',
    hostLink: 'https://githabb.github.io/DiorWeb/',
  },
  {
    title: 'Sup',
    img: project02,
    imgBig: project02Big,
    skills: 'Html, CSS, JS, адаптація сайту під мобільні пристрої',
    gitHubLink: 'https://github.com/githabb/Sup.git',
    hostLink: 'https://githabb.github.io/Sup/',
  },
  {
    title: 'Gidrotsikly',
    img: project03,
    imgBig: project03Big,
    skills: 'Html, CSS, JS, адаптація сайту під мобільні пристрої',
    gitHubLink: 'https://github.com/githabb/Gidrotsikly.git',
    hostLink: 'https://githabb.github.io/Gidrotsikly/',
  },
  {
    ...
    imgBig: project04Big,
    skills:
      'GULP, Grid, SCSS, Flex, БЕМ, MixItUp3, fancybox, наразі працюю над хостингом для цього сайту ',
  ...
  },
  {
    ...
    imgBig: project05Big,
    skills: 'HTML, CSS, JS, адаптація сайту під мобільні пристрої',
    gitHubLink: 'https://github.com/githabb/portfolio.git',
  ...
  },
  {
    ...
    imgBig: project06Big,
    skills:
      'React, React Router, React Context, react-slick, SASS / CSS Modules, Axios, адаптація сайту під мобільні пристрої',
